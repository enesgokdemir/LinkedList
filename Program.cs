...
namespace CustomLinkedList
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            list.Push(new Person() { Name = "Enes", Surname = "Gokdemir", Age = 21, TC = "12345678902" });
            list.Push(new Person() { Name = "Eren", Surname = "Torun", Age = 20, TC = "12345678905" });
            list.Append(new Person() { Name = "Emin", Surname = "Gokdemir", Age = 16, TC = "12345678906" });
            list.InsertAfter(new Person() { Name = "Elif", Surname = "Yamac", Age = 20, TC = "77734535345" }, list.Head.Next);
